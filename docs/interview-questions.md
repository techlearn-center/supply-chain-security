# Supply Chain Security Interview Questions and Answers (50+)

## Beginner (1-10)

### 1. What is Supply Chain Security and why is it important in modern engineering?
**Answer:** Supply Chain Security is essential for building reliable, scalable, and automated systems. It reduces manual toil, increases deployment velocity, and ensures consistency across environments.

### 2. What are the core components of Supply Chain Security?
...
### 3. How does Supply Chain Security fit into the DevOps or ML lifecycle?
...
### 4. What are the most common challenges with Supply Chain Security?
