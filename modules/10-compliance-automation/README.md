# Module 10: Compliance Automation & Audit
...
- Understand the core concepts of Compliance Automation & Audit
...
Compliance Automation & Audit is a fundamental component of Software Supply Chain Security: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Compliance Automation & Audit like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/10-compliance-automation/
```
...
```bash
ls modules/10-compliance-automation/lab/starter/
```
...
cd modules/10-compliance-automation/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/10-compliance-automation/validation/validate.sh
```
...
1. What is the main purpose of Compliance Automation & Audit?
...
- [ ] Validation script passes: `bash modules/10-compliance-automation/validation/validate.sh`
