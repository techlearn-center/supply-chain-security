# Module 02: SBOM Generation & Management
...
- Understand the core concepts of SBOM Generation & Management
...
### What is SBOM Generation & Management?

SBOM Generation & Management is a fundamental component of Software Supply Chain Security: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of SBOM Generation & Management like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/02-sbom-generation/lab/starter/
```
...
cd modules/02-sbom-generation/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/02-sbom-generation/validation/validate.sh
```
...
1. What is the main purpose of SBOM Generation & Management?
...
- [ ] Validation script passes: `bash modules/02-sbom-generation/validation/validate.sh`
...
**Next: [Module 03 →](../03-dependency-scanning/)**
