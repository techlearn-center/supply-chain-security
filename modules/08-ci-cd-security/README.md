# Module 08: Securing CI/CD Pipelines
...
- Understand the core concepts of Securing CI/CD Pipelines
...
### What is Securing CI/CD Pipelines?

Securing CI/CD Pipelines is a fundamental component of Software Supply Chain Security: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Securing CI/CD Pipelines like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/08-ci-cd-security/lab/starter/
```
...
cd modules/08-ci-cd-security/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/08-ci-cd-security/validation/validate.sh
```
...
1. What is the main purpose of Securing CI/CD Pipelines?
...
- [ ] Validation script passes: `bash modules/08-ci-cd-security/validation/validate.sh`
...
**Next: [Module 09 →](../09-registry-security/)**
