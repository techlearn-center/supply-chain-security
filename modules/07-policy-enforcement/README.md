# Module 07: Policy Enforcement with OPA/Kyverno
...
- Understand the core concepts of Policy Enforcement with OPA/Kyverno
...
### What is Policy Enforcement with OPA/Kyverno?

Policy Enforcement with OPA/Kyverno is a fundamental component of Software Supply Chain Security: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Policy Enforcement with OPA/Kyverno like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/07-policy-enforcement/
```
...
```bash
ls modules/07-policy-enforcement/lab/starter/
```
...
cd modules/07-policy-enforcement/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/07-policy-enforcement/validation/validate.sh
```
...
1. What is the main purpose of Policy Enforcement with OPA/Kyverno?
...
- [ ] Validation script passes: `bash modules/07-policy-enforcement/validation/validate.sh`
...
**Next: [Module 08 →](../08-ci-cd-security/)**
