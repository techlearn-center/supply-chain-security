# Module 04: Container Image Security & Signing
...
- Understand the core concepts of Container Image Security & Signing
...
### What is Container Image Security & Signing?

Container Image Security & Signing is a fundamental component of Software Supply Chain Security: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Container Image Security & Signing like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/04-container-image-security/
```
...
```bash
ls modules/04-container-image-security/lab/starter/
```
...
cd modules/04-container-image-security/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/04-container-image-security/validation/validate.sh
```
...
1. What is the main purpose of Container Image Security & Signing?
...
- [ ] Validation script passes: `bash modules/04-container-image-security/validation/validate.sh`
...
**Next: [Module 05 →](../05-sigstore-cosign/)**
