# Module 06: SLSA Framework & Provenance
...
- Understand the core concepts of SLSA Framework & Provenance
...
### What is SLSA Framework & Provenance?

SLSA Framework & Provenance is a fundamental component of Software Supply Chain Security: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of SLSA Framework & Provenance like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/06-slsa-provenance/lab/starter/
```
...
cd modules/06-slsa-provenance/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/06-slsa-provenance/validation/validate.sh
```
...
1. What is the main purpose of SLSA Framework & Provenance?
...
- [ ] Validation script passes: `bash modules/06-slsa-provenance/validation/validate.sh`
...
**Next: [Module 07 →](../07-policy-enforcement/)**
